...
io.on('connection', function(socket){
  ...
  //     console.log("getLeaders",doc);
  //   })

  // })
  // 
  // socket.on('createLobby', function(data, lobbyName){
  //   socket.lobby  = lobbyName;
  //   socket.join(socket.lobby);
  //   Lobby.findOne({lobby: socket.lobby}, function(err, doc){
  //     if(doc === null){
  //       Lobby.insert({
  //         lobby: socket.lobby,
  //         users: [data]
  //       }, function(err, doc){
  //         console.log(doc);
  //         io.in(socket.room).emit('usersInLobby', doc);
  //       })
  //     }else{
  //       Lobby.update(
  //         { lobby: socket.lobby },
